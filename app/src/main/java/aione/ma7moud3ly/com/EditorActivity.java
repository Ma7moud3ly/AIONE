...
public class EditorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ed.SCRIPT_PATH = MainActivity.scripts_path;
    ...
    private void read_script() {
        ...
        if (!path.equals("")) {
            ...
            editor.setText(Scripts.read(path));
            title.setText(name);
            ed.count_lines();
        }
    }
    ...
    public void edButtons(View v) {
        switch (v.getId()) {
            ...
            case R.id.edShare://save and share file
                ...
                ed.check_save();
                break;
            case R.id.edRun://save and run file
                ed.AFTER_SAVE = Editor.RUN;
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions,
        ...
        if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            File dir = new File(MainActivity.scripts_path);
